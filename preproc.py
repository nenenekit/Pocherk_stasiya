...
if __name__ == "__main__":
    ...
    CONTRAST = 3.0# Усиление контрастности 0-3
    BRIGHTNESS = 1.5# Усиление яркости 0-3
    SHARPNESS = 2.6 # Усиление резкости 0-3
    BORDER = 6# Размер белой рамки 5-20
    THRESHOLD = 150# Порог бинаризации (-1 = не применять) 50-300
